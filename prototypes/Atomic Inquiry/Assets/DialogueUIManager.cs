...
public class DialogueUIManager : MonoBehaviour
{
    ...
    [SerializeField]
    GameObject choice3Panel;
    [SerializeField]
    GameObject choice4Panel;
    [SerializeField]
    GameObject choice3Text;
    [SerializeField]
    GameObject choice4Text;
    [SerializeField]
    ...
    public IEnumerator HideDialogueUI()
    {
        ...
        Coroutine fadeChoice3Textt = StartCoroutine(fadeChoice3Text(true));
        Coroutine fadeChoice3Panell = StartCoroutine(fadeChoice3Panel(true));
        Coroutine fadeChoice4Textt = StartCoroutine(fadeChoice4Text(true));
        Coroutine fadeChoice4Panell = StartCoroutine(fadeChoice4Panel(true));
        ...
        yield return fadeChoice3Panell;
        yield return fadeChoice3Textt;
        yield return fadeChoice4Panell;
        yield return fadeChoice4Textt;
        yield return fadeExitButton;
    ...
    public IEnumerator ShowChoicesUI(bool choice1, bool choice2, bool choice3, bool choice4) {
        Coroutine fadeChoice1;
        Coroutine fadeChoice2;
        Coroutine fadeChoice3;
        Coroutine fadeChoice4;
        
        fadeChoice1 = StartCoroutine(fadeChoice1Panel(!choice1));

        fadeChoice2 = StartCoroutine(fadeChoice2Panel(!choice2));

        fadeChoice3 = StartCoroutine(fadeChoice3Panel(!choice3));

        fadeChoice4 = StartCoroutine(fadeChoice4Panel(!choice4));
    ...
    {
        if (!string.IsNullOrEmpty(choice3Text.GetComponent<TextMeshProUGUI>().text))
        {
            yield return StartCoroutine(fadeChoice3Text(true));
        }
    ...
    {
        if (!string.IsNullOrEmpty(choice4Text.GetComponent<TextMeshProUGUI>().text))
        {
            yield return StartCoroutine(fadeChoice4Text(true));
        }
    ...
    void resetALlAlphas() { 
        ...
        choice3Panel.GetComponent<CanvasRenderer>().SetAlpha(0);
        choice4Panel.GetComponent<CanvasRenderer>().SetAlpha(0);
        choice3Text.GetComponent<CanvasRenderer>().SetAlpha(0);
        choice4Text.GetComponent<CanvasRenderer>().SetAlpha(0);
    ...
    void enableEverything(bool enable) {
        ...
        choice3Panel.gameObject.SetActive(enable);
        choice4Panel.gameObject.SetActive(enable);
        choice3Text.gameObject.SetActive(enable);
        choice4Text.gameObject.SetActive(enable);
    ...
    void resetAllText() {
        ...
        choice3Text.GetComponent<TextMeshProUGUI>().text = "";
        choice4Text.GetComponent<TextMeshProUGUI>().text = "";
    ...
    public IEnumerator fadeChoice3Text(bool shouldI)
    {
        if (shouldI)
        {
            while (choice3Text.GetComponent<CanvasRenderer>().GetAlpha() > 0)
            {
                float newAlpha = choice3Text.GetComponent<CanvasRenderer>().GetAlpha() - fadeSpeed * Time.deltaTime;
                choice3Text.GetComponent<CanvasRenderer>().SetAlpha(newAlpha);
                yield return null;
            }
        }
        else
        {
            while (choice3Text.GetComponent<CanvasRenderer>().GetAlpha() < 1)
            {
                float newAlpha = choice3Text.GetComponent<CanvasRenderer>().GetAlpha() + fadeSpeed * Time.deltaTime;
                choice3Text.GetComponent<CanvasRenderer>().SetAlpha(newAlpha);
                yield return null;
    ...
    public IEnumerator fadeChoice4Text(bool shouldI)
    {
        if (shouldI)
        {
            while (choice4Text.GetComponent<CanvasRenderer>().GetAlpha() > 0)
            {
                float newAlpha = choice4Text.GetComponent<CanvasRenderer>().GetAlpha() - fadeSpeed * Time.deltaTime;
                choice4Text.GetComponent<CanvasRenderer>().SetAlpha(newAlpha);
                yield return null;
            }
        }
        else
        {
            while (choice4Text.GetComponent<CanvasRenderer>().GetAlpha() < 1)
            {
                float newAlpha = choice4Text.GetComponent<CanvasRenderer>().GetAlpha() + fadeSpeed * Time.deltaTime;
                choice4Text.GetComponent<CanvasRenderer>().SetAlpha(newAlpha);
                yield return null;
    ...
    public IEnumerator fadeChoice3Panel(bool shouldI)
    {
        if (shouldI)
        {
            while (choice3Panel.GetComponent<CanvasRenderer>().GetAlpha() > 0)
            {
                float newAlpha = choice3Panel.GetComponent<CanvasRenderer>().GetAlpha() - fadeSpeed * Time.deltaTime;
                choice3Panel.GetComponent<CanvasRenderer>().SetAlpha(newAlpha);
        ...
        {
            while (choice3Panel.GetComponent<CanvasRenderer>().GetAlpha() < 1)
            {
                float newAlpha = choice3Panel.GetComponent<CanvasRenderer>().GetAlpha() + fadeSpeed * Time.deltaTime;
                choice3Panel.GetComponent<CanvasRenderer>().SetAlpha(newAlpha);
    ...
    public IEnumerator fadeChoice4Panel(bool shouldI)
    {
        if (shouldI)
        {
            while (choice4Panel.GetComponent<CanvasRenderer>().GetAlpha() > 0)
            {
                float newAlpha = choice4Panel.GetComponent<CanvasRenderer>().GetAlpha() - fadeSpeed * Time.deltaTime;
                choice4Panel.GetComponent<CanvasRenderer>().SetAlpha(newAlpha);
        ...
        {
            while (choice4Panel.GetComponent<CanvasRenderer>().GetAlpha() < 1)
            {
                float newAlpha = choice4Panel.GetComponent<CanvasRenderer>().GetAlpha() + fadeSpeed * Time.deltaTime;
                choice4Panel.GetComponent<CanvasRenderer>().SetAlpha(newAlpha);
