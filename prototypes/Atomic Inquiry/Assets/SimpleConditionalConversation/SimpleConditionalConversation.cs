...
public class SimpleConditionalConversation 
{
	...
	public void loadLines(List<Dictionary<string, object>> data) 
	{
		...
		for (var i = 0; i < data.Count; i++) {
            ...
            line.choice3 = (string)data[i]["choice3"];
            line.choice4 = (string)data[i]["choice4"];
            ...
            line.choice3EffectLeft = (string)data[i]["choice3EffectLeft"];
            line.choice3EffectRight = (string)data[i]["choice3EffectRight"];
            line.choice3EffectOp = (string)data[i]["choice3EffectOp"];
            line.choice4EffectLeft = (string)data[i]["choice4EffectLeft"];
            line.choice4EffectRight = (string)data[i]["choice4EffectRight"];
            line.choice4EffectOp = (string)data[i]["choice4EffectOp"];
	...
	*/
	...
	public void makeChoice(int choice, SCCLine line)
	{
		...
		{
			setGameStateValue(line.character, line.choice3EffectLeft, line.choice3EffectOp, line.choice3EffectRight);
		}
		else if (choice == 4)
		{
			setGameStateValue(line.character, line.choice4EffectLeft, line.choice4EffectOp, line.choice4EffectRight);
		}
	}
